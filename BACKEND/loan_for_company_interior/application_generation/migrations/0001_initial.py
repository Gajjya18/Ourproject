    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_of_employment', models.CharField(blank=True, choices=[('SELECT', 'SELECT'), ('SELF_EMPLOYED', 'SELF_UMPLOYED'), ('SALARIED', 'SALARIED')], default=0, max_length=250)),
                ('business_title', models.CharField(blank=True, default=0, max_length=250)),
                ('business_type', models.CharField(blank=True, choices=[('SELECT', 'SELECT'), ('MANUFACTURING', 'MANUFACTURING'), ('SERVICE', 'SERVICE'), ('TRADING', 'TRADING')], default=0, max_length=250)),
                ...
                ('status', models.CharField(choices=[('SELECT', 'SELECT'), ('GENERATED', 'GENERATED'), ('DOCUMENT_VERIFIED', 'DOCUMENT_VERIFIED'), ('SANCTIONED', 'SANCTIONED'), ('DISBURST', 'DISBURST'), ('REJECTED', 'REJECTED')], default='', max_length=250)),
                ('application_timestamp', models.DateTimeField(auto_now_add=True)),
                ('remark', models.CharField(blank=True, default=0, max_length=250)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Applications', to='admin_app.user')),
            ],
        ),
        migrations.CreateModel(
            name='Guarantor',
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('SELECT', 'SELECT'), ('MALE', 'MALE'), ('FEMALE', 'FEMALE'), ('TRANSGENDER', 'TRANSGENDER')], default=0, max_length=50)),
